...
class AdminFlightsController extends Controller
{
    ...
    public function actionIndex()
    {
        $flights = Flight::find()
            ...
            ->orderBy(['flights.departure_time' => SORT_ASC])
            ->all();
    ...
    public function actionCreate()
    {
        ...
        if (isset($data['departure_time'])) {
            ...
            try {
                ...
                $flight->departure_time = $dt->format('Y-m-d H:i:s');
            } catch (\Exception $e) {
                // Fallback: simple string replacement
                $departureTime = str_replace('Z', '', $departureTime);
        ...
        if (isset($data['arrival_time'])) {
            ...
            try {
                ...
                $flight->arrival_time = $dt->format('Y-m-d H:i:s');
            } catch (\Exception $e) {
                // Fallback: simple string replacement
                $arrivalTime = str_replace('Z', '', $arrivalTime);
